...
spider = "http://localhost:8080/JSON/ascan/action/scan/?zapapiformat=JSON&formMethod=GET&url="
sumpay = "&recurse=&inScopeOnly=&scanPolicyName=&method=&postData=&contextId="
Const Quote = """"
